...
# SLURM_TMPDIR=/network/tmp1/bhattdha
# 3. Launch your job, tell it to save the model in $SLURM_TMPDIR
#    and look for the dataset into $SLURM_TMPDIR
export NGPUS=2
ln -nsf $SLURM_TMPDIR/coco_dataset_new/val2017_modified/ datasets/coco/val2017_new
ln -nsf $SLURM_TMPDIR/coco_dataset_new/train2017_modified/ datasets/coco/train2017_new
ln -nsf $SLURM_TMPDIR/coco_dataset_new/annotations_modified/instances_val2017_modified.json datasets/coco/annotations/instances_val2017_new.json
ln -nsf $SLURM_TMPDIR/coco_dataset_new/annotations_modified/instances_train2017_modified.json datasets/coco/annotations/instances_train2017_new.json
